...
I achieved this using the CUCM **SOAP/AXL API**. (If you're unfamiliar with it, I wrote a [previous post](/posts/querying-cucm-database-using-sql/) about it. While it's not exhaustive, it's a good starting point if you're interested.)
...
voicemail_calls_text = voicemailCalls[['dateTimeEastern']].to_string(index=False, header=False)
